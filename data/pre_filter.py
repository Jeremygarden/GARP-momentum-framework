...
TARGET_INDUSTRY_CODES = {
    ...
    # ── 2026-06-12 新增：AI底层材料 / 先进制造 ──
    10,   # 非金属矿物制品（精密陶瓷/三环集团/国瓷材料 — LTCC/先进陶瓷）
    18,   # 橡胶塑料及制品（含特种高分子/先进复合材料）
    13,   # 有色金属矿采（稀有金属/稀土/钴锂 — AI材料链上游）
    14,   # 有色金属冶炼（铜铝锂精炼/超细粉末 — 博迁新材类）
    11,   # 造纸印刷（含电子玻纤布/高性能基材 — 宏和科技类）
    22,   # 纺织服装（含高性能纤维/碳纤维/石英纤维 — 菲利华类）
    17,   # 化学纤维（高纯石英/光纤预制棒原材料）
    23,   # 皮革毛皮（保留低权重，暂不排除边缘先进材料）
}
