...
def main():
    ...
    parser.add_argument('--output-dir', dest='output_dir', help='输出目录，默认 ~/.openclaw/workspace/mx_data/output/')
    ...
    # Default output directory is fixed to ~/.openclaw/workspace/mx_data/output/
    default_output = Path(os.environ.get("HOME", "/root")) / ".openclaw/workspace/mx_data/output"
